...
<div class="container mx-auto px-4 sm:px-6 lg:px-8 py-8">
    <div class="max-w-3xl mx-auto">
        <div class="flex justify-between items-center mb-6">
            <h1 class="text-2xl font-semibold text-gray-700">Tambah Anggota Tim</h1>
            @php
        ...
        <div class="bg-white shadow-md rounded-lg overflow-hidden p-6">
            <form action="{{ route($routePrefix . '.team-members.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="role" id="role" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" value="{{ old('role') }}" required>
                </div>
                ...
                <div class="mb-4">
                    ...
                    <select name="category" id="category" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" required>
                        <option value="UKS" {{ old('category') == 'UKS' ? 'selected' : '' }}>UKS</option>
                        <option value="BK" {{ old('category') == 'BK' ? 'selected' : '' }}>BK</option>
                    </select>
                </div>
                ...
                <div class="mb-4">
                    <label for="image" class="block text-gray-700 text-sm font-bold mb-2">Foto Anggota:</label>
