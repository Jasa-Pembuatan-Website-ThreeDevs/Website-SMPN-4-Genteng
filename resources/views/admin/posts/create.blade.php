...
<div class="max-w-4xl mx-auto p-6">
    <div class="bg-white rounded-2xl shadow-sm border border-slate-200 p-8">
            ...
            <div class="grid grid-cols-2 gap-6">
                <div>
                    ...
                    <select name="announcement" class="w-full border-slate-200 rounded-xl focus:ring-4 focus:ring-blue-100 focus:border-blue-500 border p-3 transition" required>
                        ...
                        <option value="news" {{ old('announcement') == 'news' ? 'selected' : '' }}>Berita</option>
                        <option value="announcement" {{ old('announcement') == 'announcement' ? 'selected' : '' }}>Pengumuman</option>
                    </select>
                </div>
                ...
                <div>
                    ...
                    <label class="flex items-center gap-2 cursor-pointer">
                        <input type="checkbox" name="is_active" value="1" {{ old('is_active') ? 'checked' : '' }} class="w-5 h-5">
        ...
        <form action="{{ route('officer.posts.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
            @csrf
