        ...
        <div class="flex-1 px-4 py-2 overflow-y-auto custom-scrollbar space-y-8">
            ...
            <div class="space-y-1">
                ...
                @if(auth()->user()->role == 'administrator')
                    ...
                    <x-sidebar-link :href="route('admin.teacher.index')" :active="request()->routeIs('admin.teacher.*')">
                ...
                @elseif(auth()->user()->role == 'officer')
                    ...
                    <x-sidebar-link :href="route('officer.teacher.index')" :active="request()->routeIs('officer.kepala-sekolah.*')">
                        <i class="fas fa-user-tie w-5 text-yellow-400/80"></i>
                        <span class="ms-3">Guru/Karyawan</span>
                    </x-sidebar-link>
                @endif
