...
<body>
    <div class="form-container">
        <div class="form-header">
            ...
            <p>Isi form berikut untuk {{ isset($achievement) ? 'mengubah data prestasi' : 'menambahkan prestasi baru' }} SMPN 4 Genteng</p>
        </div>
        
        <form method="POST" 
              action="{{ isset($achievement) 
            ...
            <div class="form-row">
                ...
                <div class="form-group">
                    ...
                    <select name="level" id="level" class="form-control" required>
                        <option value="" disabled {{ !old('level', isset($achievement) ? $achievement->level : '') ? 'selected' : '' }}>Pilih Tingkat Prestasi</option>
                        <option value="Kecamatan" {{ old('level', isset($achievement) ? $achievement->level : '') == 'Kecamatan' ? 'selected' : '' }}>Kecamatan</option>
                        <option value="Kabupaten" {{ old('level', isset($achievement) ? $achievement->level : '') == 'Kabupaten' ? 'selected' : '' }}>Kabupaten</option>
            ...
            <div class="form-row">
                ...
                <div class="form-group">
                        ...
                        <label for="image" class="file-upload-label">
                            <div class="file-upload-content">
                                ...
                                <div class="file-upload-text">
                                    <h4>Unggah Gambar</h4>
                                    <p>Klik untuk memilih file atau tarik dan lepas di sini</p>
                                    <p style="font-size: 0.85rem; margin-top: 5px;">Format: JPG, PNG, GIF (Maks. 5MB)</p>
                                </div>
                            </div>
                        </label>
                        <input type="file" 
                    ...
                    <div class="file-preview" id="filePreview">
                        <div class="file-preview-item">
                            ...
                            <div class="file-preview-info">
                                <div class="file-preview-name" id="fileName">Nama file akan muncul di sini</div>
                                <div class="file-preview-size" id="fileSize">Ukuran file akan muncul di sini</div>
                            </div>
                    ...
                    <div style="margin-top: 15px; padding: 15px; background: var(--light); border-radius: var(--radius-md);">
                        <p style="font-weight: 600; margin-bottom: 10px; color: var(--dark);">
                            <i class="fas fa-image" style="color: var(--primary); margin-right: 8px;"></i>
                            Gambar Saat Ini
                        </p>
                        <p style="color: var(--gray); font-size: 0.95rem;">
                            Jika Anda mengunggah gambar baru, gambar lama akan digantikan.
                        </p>
                    </div>
                    @endif
            ...
            <div class="form-group">
                ...
                <textarea name="description" 
                          id="description"
                          class="form-control"
                          placeholder="Deskripsikan prestasi yang diraih, siapa yang meraih, di event apa, dan detail lainnya..."
                          rows="6"
            ...
            <div class="form-footer">
                <p><i class="fas fa-info-circle"></i> Pastikan semua data yang dimasukkan sudah benar sebelum disimpan.</p>
