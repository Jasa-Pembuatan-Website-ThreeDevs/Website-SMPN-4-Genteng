    ...
    <main class="main-content-section pt-32 pb-20">
        <div class="container">
            <div class="text-center mb-16">
                <span class="text-blue-600 font-bold tracking-wider uppercase text-sm mb-2 block">Pusat Informasi</span>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <div class="group bg-white rounded-2xl overflow-hidden border border-slate-100 hover:shadow-2xl hover:shadow-blue-600/10 transition-all duration-300 flex flex-col h-full">
                    <a href="{{ route('announcements.public.show', $announcement) }}" class="block relative h-56 overflow-hidden">
                        ...
                        @else
                        <div class="w-full h-full bg-gradient-to-br from-blue-600 to-indigo-700 flex items-center justify-center text-white">
                    ...
                    <div class="p-8 flex flex-col flex-grow">
                        <div class="flex items-center gap-3 mb-4">
                            <span class="bg-blue-50 text-blue-600 px-3 py-1 rounded-full text-[10px] font-extrabold uppercase tracking-widest">
                                Penting
                            </span>
                        ...
                        <h2 class="text-xl font-bold text-slate-800 mb-3 group-hover:text-blue-600 transition-colors line-clamp-2 leading-tight">
                        ...
                        <div class="pt-6 border-t border-slate-100 mt-auto">
                            <a href="{{ route('announcements.public.show', $announcement) }}" 
                               class="inline-flex items-center text-blue-600 font-bold text-sm group/btn">
                                Baca Pengumuman
            ...
            <div class="flex flex-col items-center justify-center py-24 bg-white rounded-3xl border-2 border-dashed border-slate-200">
                ...
                <a href="/" class="mt-8 px-8 py-3 bg-blue-600 text-white font-bold rounded-full hover:bg-blue-700 transition-all shadow-lg shadow-blue-600/30">
                    Kembali ke Beranda
                </a>
            </div>
            @endif
