                ...
                <div class="flex flex-wrap gap-4 mb-12">
                    @if(isset($activeBatch) && $activeBatch)
                        <a href="/spmb" class="px-8 py-4 bg-blue-600 text-white font-bold rounded-2xl hover:bg-blue-700 transition-all shadow-xl shadow-blue-600/25 flex items-center gap-3 group pulse-animation">
                            ...
                            Daftar SPMB {{ now()->year }}
                            <i class="fas fa-arrow-right text-xs group-hover:translate-x-1 transition-transform"></i>
                        </a>
                    @else
                        <div class="px-8 py-4 bg-gray-100 text-gray-500 font-bold rounded-2xl border border-gray-200 flex items-center gap-3 cursor-not-allowed">
