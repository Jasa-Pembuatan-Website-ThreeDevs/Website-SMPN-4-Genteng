<div class="min-h-screen bg-gray-50 pb-20">
    @if($activeBatch)
        <div class="relative bg-white overflow-hidden mt-10">
            <div class="absolute inset-0 z-0">
                ...
                <div class="absolute top-0 left-0 -ml-20 -mt-20 w-80 h-80 rounded-full bg-blue-500 opacity-10 blur-3xl"></div>
                <div class="absolute bottom-0 right-0 -mr-20 -mb-20 w-80 h-80 rounded-full bg-teal-400 opacity-10 blur-3xl"></div>
            </div>

            <div class="container mx-auto px-4 py-16 relative z-10 text-center">
                <span class="inline-block py-1 px-3 rounded-full bg-green-500/20 text-green-300 text-sm font-semibold mb-4 border border-green-500/30 animate-pulse">
                    🟢 Status: Pendaftaran Dibuka
                </span>
                
                <h1 class="text-4xl md:text-5xl font-extrabold text-white mb-4 tracking-tight">
                    PPDB Online <span class="text-transparent bg-clip-text bg-gradient-to-r from-blue-200 to-teal-200">SMPN 4 Genteng</span>
                </h1>
                
                <p class="text-blue-100 text-lg md:text-xl max-w-2xl mx-auto mb-8">
                    Bergabunglah menjadi bagian dari keluarga besar kami. Daftar sekarang melalui jalur <strong class="text-white bg-white/10 px-2 py-1 rounded">{{ $activeBatch->name }}</strong>
                </p>

                <div class="bg-white/10 backdrop-blur-md border border-white/20 rounded-2xl p-6 max-w-3xl mx-auto mb-10 flex flex-col md:flex-row justify-between items-center gap-6">
                ...
                <a href="#registration-form" class="group inline-flex items-center bg-white text-blue-900 px-8 py-4 rounded-full text-lg font-bold shadow-[0_0_20px_rgba(255,255,255,0.3)] hover:shadow-[0_0_30px_rgba(255,255,255,0.5)] transition-all duration-300 transform hover:-translate-y-1">
    ...
    @else
        <div class="min-h-[80vh] flex items-center justify-center bg-gray-50 px-4">
            <div class="max-w-lg w-full text-center bg-white p-10 rounded-3xl shadow-2xl border border-gray-100 relative overflow-hidden">
                <div class="absolute top-0 right-0 -mr-10 -mt-10 w-40 h-40 bg-red-50 rounded-full blur-2xl opacity-50"></div>
                
                <div class="relative z-10">
                    <div class="w-24 h-24 bg-red-100 text-red-500 rounded-full flex items-center justify-center mx-auto mb-6 text-4xl animate-bounce">
                    ...
                    <div class="space-y-3">
                        <a href="{{ route('dashboard') }}" class="block w-full bg-gray-900 text-white px-8 py-3 rounded-xl font-bold hover:bg-gray-800 transition shadow-lg transform hover:-translate-y-1">
                            Kembali ke Beranda
                        </a>
                        <a href="#" class="block w-full bg-white text-gray-700 border-2 border-gray-200 px-8 py-3 rounded-xl font-bold hover:bg-gray-50 transition">
