...
<head>
    ...
    <title>PPDB Online | SMPN 4 Genteng</title>
            ...
            @if($activeBatch)
                <div class="relative bg-white overflow-hidden shadow-sm">
                    <div class="absolute inset-0 z-0">
                        <div class="absolute inset-0 bg-gradient-to-r from-blue-900 to-indigo-900 opacity-95"></div>
                        <div class="absolute top-0 left-0 -ml-16 -mt-16 w-64 h-64 rounded-full bg-blue-500 opacity-10 blur-3xl">
                        </div>
                        <div class="absolute bottom-0 right-0 -mr-16 -mb-16 w-64 h-64 rounded-full bg-teal-400 opacity-10 blur-3xl">
                        </div>
                    </div>

                    <div class="container mx-auto px-4 py-10 relative z-10 text-center">
                        <span
                            class="inline-block py-1 px-3 rounded-full bg-green-500/20 text-green-300 text-[10px] font-semibold mb-2 border border-green-500/30 animate-pulse">
                        ...
                        <p class="text-blue-100 text-sm md:text-base max-w-xl mx-auto mb-5">
                            Bergabunglah menjadi bagian dari keluarga besar kami. Daftar sekarang melalui jalur <strong
                                class="text-white bg-white/10 px-2 py-0.5 rounded">{{ $activeBatch->name }}</strong>
                        </p>

                        <div
                            class="bg-white/10 backdrop-blur-md border border-white/20 rounded-2xl p-4 md:p-5 max-w-2xl mx-auto mb-6 flex flex-col md:flex-row justify-between items-center gap-4 md:gap-6">
                            <div class="text-center md:text-left">
                                <p class="text-blue-200 text-[10px] uppercase tracking-wider mb-0.5">Gelombang Saat Ini</p>
                                <p class="text-lg md:text-xl font-bold text-white">{{ $activeBatch->name }}</p>
                            </div>
                            <div class="hidden md:block w-px h-8 bg-white/20"></div>
                            <div class="text-center md:text-right">
                                <p class="text-blue-200 text-[10px] uppercase tracking-wider mb-0.5">Batas Pendaftaran</p>
                        ...
                        <a href="#registration-form"
                            class="group inline-flex items-center bg-white text-blue-900 px-6 py-3 rounded-full text-sm font-bold shadow-[0_0_15px_rgba(255,255,255,0.2)] hover:shadow-[0_0_25px_rgba(255,255,255,0.4)] transition-all duration-300 transform hover:-translate-y-1">
                    ...
                    <div class="absolute bottom-0 left-0 right-0">
                        <svg class="fill-gray-50 h-12 w-full" viewBox="0 0 1440 120" preserveAspectRatio="none" xmlns="http://www.w3.org/2000/svg">
                            <path
                ...
                <div id="registration-form" class="container mx-auto px-4 -mt-6 relative z-20 scroll-mt-24">
