                    ...
                    <div class="form-grid">
                        <div class="form-group">
                            ...
                            <div class="input-wrapper text-black">
                                ...
                                <input type="text" name="name" placeholder="Sesuai Ijazah SD/MI" required>
                            </div>
                        </div>
                        <div class="form-group">
                            <label>NISN</label>
                            <div class="input-wrapper text-black">
                                ...
                                <input type="number" name="nisn" placeholder="10 digit NISN" required>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="input-wrapper text-black">
                                ...
                                <input type="text" name="birth_place" placeholder="Kota Kelahiran" required>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-wrapper text-black">
                                ...
                                <input type="text" name="origin_school" placeholder="Nama SD/MI Asal" required>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-grid">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-wrapper text-black">
                                ...
                                <input type="text" name="parent_name" placeholder="Nama Ayah/Ibu" required>
                            </div>
                        </div>
                        <div class="form-group">
